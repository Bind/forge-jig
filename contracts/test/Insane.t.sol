...
import {InsaneExampleJig} from "contracts/jig/InsaneExampleJig.sol";
import "contracts/insane.sol";
import "forge-std/stdlib.sol";
import "forge-std/Vm.sol";
import "./utils/console.sol";

contract Insane is DSTest {
    InsaneExample b;
    InsaneExampleJig jig;
    Vm public constant vm =
        Vm(address(bytes20(uint160(uint256(keccak256("hevm cheat code"))))));

    function setUp() public {
        b = new InsaneExample();
        jig = new InsaneExampleJig(address(b));
    }
